...
class CategoryRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'category_name.max' => 'Tên loại sản phẩm không được ngắn hơn 5 kí tự và không được dài hơn 50 kí tự',
            'category_name.min' => 'Tên loại sản phẩm không được ngắn hơn 5 kí tự và không được dài hơn 50 kí tự',
