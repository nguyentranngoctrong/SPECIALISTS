...
class CartController extends Controller
{
    ...
    public function __construct(CartService $cartService)
    {
        ...
        $this->data_seo = new SeoHelper('Kính chào quý khách', 'Bánh/Kẹo/Mứt, Khô các loại, Sức khỏe/Trà, Nem/Chả/Lạp, Rau/Gạo/Nấm, Rượu các loại Gia Vị', 'Đặc Sản- Chuyên cung cấp những sản phẩm đặc sản uy tín, chất lượng, giá rẻ', 'http://127.0.0.1:8000/cart');
    ...
    {
        $vnp_TmnCode = "PJ740RG5"; //Mã định danh merchant kết nối (Terminal Id)
        $vnp_HashSecret = "FMNHIPYMOULWZLUUJXVSEBIWRJUJBLYM"; //Secret key
...
//Expire
    ...
    //Hàm xử lý tính tổng theo sản phẩm giỏ hàng
